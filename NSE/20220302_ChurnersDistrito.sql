...
REALCHURNERS AS(
 SELECT DISTINCT CONTRATOCRM AS CHURNER, MaxFecha, PrimerChurn, MesChurnF, MesChurnP, ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD
 FROM CHURNERSCRM c  INNER JOIN FIRSTCHURN f ON c.CONTRATOCRM = f.CONTRATOPCHURN AND f.PrimerChurn <= c.MaxFecha
   GROUP BY 1,2,3,4,5,6,7,8),

CRUCECHURNERS AS(
SELECT CONTRATOSO, CHURNER, VOLUNTARIO, INVOLUNTARIO, MaxFecha, PrimerChurn, MesChurnF, MesChurnP,ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD,
...
GROUP BY contratoso, CHURNER, MesS, VOLUNTARIO, INVOLUNTARIO, MaxFecha, PrimerChurn, MesChurnF, MesChurnP,ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD
)

SELECT ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD, COUNT(CONTRATOSO) 
...
WHERE EXTRACT(MONTH FROM MaxFecha)=8
GROUP BY ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD
