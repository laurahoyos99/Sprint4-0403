...
WITH 
DISTRITOSIDS AS(
SELECT RemoveAccentMarks(Provincia) AS Provincia,RemoveAccentMarks(Canton) AS Canton,RemoveAccentMarks(Distrito) AS Distrito, Economica,IDS_2017
...
SELECT ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD, Economica, IDS_2017,TENURE,COUNT(CONTRATOSO) 
...
GROUP BY ACT_RGN_CD,ACT_CANTON_CD,ACT_PRVNC_CD,Economica, IDS_2017, TENURE
